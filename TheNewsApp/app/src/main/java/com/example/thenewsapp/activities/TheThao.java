...
public class TheThao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcTheThao = findViewById(R.id.rc_TheThao);
        toolbar = findViewById(R.id.toolbar);
        itemList = new ArrayList<>();
        itemAdapter = new Adapter(this ,itemList);

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, RecyclerView.VERTICAL, false);
        rcTheThao.setLayoutManager(linearLayoutManager);
        rcTheThao.setAdapter(itemAdapter);
    ...
    private void getListItem(){
        paperRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                        ...
                        if(item.getCategory().equals(Categories.THE_THAO)){
                            itemList.add(item);
                        }
                    }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(TheThao.this, "Fails", Toast.LENGTH_SHORT).show();
            }
        });
    }
